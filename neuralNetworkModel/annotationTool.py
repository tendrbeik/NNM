    ...
    if filename.endswith(('.jpg', '.jpeg', '.png')):
        ...
        while True:
            ...
            if key == ord(' '):  # Нажатие пробела для сохранения
                ...
                output_image_path = os.path.join(valid_images_path, filename)
                ...
                label_file_path = os.path.join(valid_labels_path , label_filename)
                ...
                print("Skipped image")
                break
            elif key in [ord(str(i)) for i in range(2)]:  # Выбор класса
